...
interface TransferenciaTercerosProps {
  cuentas: Cuenta[];
  onTransferir: (data: any) => Promise<void>;
  loading?: boolean;
}

export function TransferenciaTerceros({
  cuentas,
  onTransferir,
  loading = false,
}: TransferenciaTercerosProps) {
  ...
  return (
    <Card className="p-6">
      <h2 className="text-lg font-semibold mb-6">Transferencia a terceros (mismo banco)</h2>
